        ...
        <>
          <div className="grid gap-x-8 gap-y-4 lg:grid-cols-4 grid-cols-1">       
                {products.map((product)=>{
                    ...
                    return(<div className="card static bg-base-100 lg:w-80 shadow-xl lg:mx-5 lg:my-2" key={product.product_id!}>
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-end">
                                    <button className="btn btn-success mx-1 w-max lg:btn-md" onClick={()=> handleOpen(product.product_id!)}>Open Product</button>
                                </div>
                            </div>
                        </div>
                    )
